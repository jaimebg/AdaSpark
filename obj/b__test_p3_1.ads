...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_p3_1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#cc98d0e2#;
   pragma Export (C, u00001, "test_p3_1B");
   ...
   u00114 : constant Version_32 := 16#e0e49bbd#;
   pragma Export (C, u00114, "p3_1B");
   u00115 : constant Version_32 := 16#6bc0dde4#;
   pragma Export (C, u00115, "p3_1S");
   ...
   u00138 : constant Version_32 := 16#35688a43#;
   pragma Export (C, u00138, "test_assertionsB");
   u00139 : constant Version_32 := 16#c1dd7c95#;
   pragma Export (C, u00139, "test_assertionsS");
